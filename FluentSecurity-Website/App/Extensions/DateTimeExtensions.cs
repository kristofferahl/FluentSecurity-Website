...
namespace FluentSecurity.Website.App.Extensions
{
	...
	{
		public static MvcHtmlString TimePastSince(this DateTime dateTime, int timeZoneDifferenceInHours, string daysTextFormat, string dayTextFormat, string hoursTextFormat, string hourTextFormat)
		{
